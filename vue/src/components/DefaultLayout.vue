<template>
  ...
  <div class="min-h-full">
    ...
    <!-- all children will inherit all this -->
...
export default{
  components:{
    Disclosure, DisclosureButton, DisclosurePanel, Menu, MenuButton, MenuItem, MenuItems,Bars3Icon, BellIcon, XMarkIcon, Notification
